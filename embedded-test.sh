...
arch_list_glibc="aarch64 aarch64be alpha armv6 armv7 arcv2 arcv2-be \
  ...
  nios2 ppc ppcsf ppc64 ppc64le riscv64 s390 sh4 sh4eb sparc64 \
  x86 x86_64 x86_64_x32"
...
get_arch_info() {
  ...
  case ${arch} in
    ...
    m68k)
      ...
      default_musl="ADK_APPLIANCE=test ADK_TARGET_OS=$os ADK_TARGET_ARCH=m68k ADK_TARGET_FS=initramfsarchive ADK_TARGET_SYSTEM=qemu-m68k-q800"
